...
const EVENT_DETAILS = {
    ...
    me1j: { description: "Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.", isShared: true, sharedWith: 'Sara Reed', isCritical: true, date: 'Jan 2025', membersAffected: 2, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: 'Review Goal Funding', members: 'Mark · Sara Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded. No adjustment made.' },
    me1k: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Sara Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Mark · Sara · Emma Reed', cashFlowImpact: '$2,800/mo starting Aug 2026', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
