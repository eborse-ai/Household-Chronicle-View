...
const EVENT_DETAILS = {
    ...
    e21: { description: 'Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.', isShared: false, sharedWith: '', isCritical: true, date: 'Jan 2025', membersAffected: 1, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: null, members: 'Mark Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded.', targetAmount: '$45,000', targetDate: 'Dec 2027', priority: 'High', goalType: 'Savings', actualAmount: '$18,500', estSuccess: '42%', startDate: 'Jan 2025', pace: 'Behind', todayPct: 50, linkedAccount: { name: 'Joint Brokerage', number: 'BRK-2020-4471', contributionAmount: '$18,500', availableBalance: '$261,500' }, competingGoals: [{ name: "Emma's 529 Plan", amount: 'Not started', status: 'Pending', statusClass: 'c-ep-goal-competing-status' }] },
