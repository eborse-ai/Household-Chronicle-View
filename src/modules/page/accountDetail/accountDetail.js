...
const EVENT_DETAILS = {
    ...
    e10: { description: "Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.", isShared: false, sharedWith: '', isCritical: true, date: 'Jan 2025', membersAffected: 1, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: 'Review Goal Funding', members: 'Mark Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded. No adjustment made.' },
    e11: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Sara Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Mark · Sara · Emma Reed', cashFlowImpact: '$2,800/mo starting Aug 2026', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
    ...
    e13: { description: 'Annual review completed with Mark only. Sara did not attend — this is the second consecutive year of absence from the annual review.', isShared: false, sharedWith: '', isCritical: true, date: 'Oct 2025', membersAffected: 1, status: 'Completed', aiInsight: "Sara has been absent from the last two annual reviews (2025, 2026). A dedicated 1:1 can re-anchor her as an active co-client.", aiActionLabel: 'Schedule 1:1 with Sara', members: 'Mark Reed (Sara absent)', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Review completed. Sara follow-up not initiated.' },
    ...
    e17: { description: "Opened a Roth IRA for Sara to add tax-free retirement growth and diversify the household's tax exposure.", isShared: false, sharedWith: '', isCritical: false, date: 'Apr 2022', membersAffected: 1, status: 'Active', aiInsight: null, aiActionLabel: null, members: 'Sara Reed', cashFlowImpact: '$500/mo contribution', beneficiaries: 'Mark Reed', actionTaken: 'Account opened and max funded.' },
    ...
    e21: { description: 'Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.', isShared: false, sharedWith: '', isCritical: true, date: 'Jan 2025', membersAffected: 1, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: null, members: 'Mark Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded.' },
    e22: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Mark Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Sara · Mark · Emma Reed', cashFlowImpact: '–$4,200/mo (parental leave)', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
    // ── Emma Reed — yearly ───────────────────────────────────────────
    e23: { description: 'Emma Reed was born, the couple\'s first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.', isShared: true, sharedWith: 'Mark Reed · Sara Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'Noted', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Emma · Mark · Sara Reed', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Emma added as household dependent.' },
    ...
    me1e: { description: "Mark was promoted with a salary increase and a 4-year-vesting RSU grant, raising household income and introducing concentrated equity to plan around.", isShared: false, sharedWith: '', isCritical: false, date: 'Apr 2022', membersAffected: 1, status: 'Noted', aiInsight: "Salary increase creates an opportunity to boost retirement contributions and increase the car savings goal rate. Consider a Mega Backdoor Roth if the employer plan allows.", aiActionLabel: 'Review Contribution Strategy', members: 'Mark Reed', cashFlowImpact: '+$15K/yr income', beneficiaries: null, actionTaken: 'Income updated in plan.', sentimentInsights: [{ name: 'Mark Reed', role: 'Primary Client', keyword: 'Ambitious', insight: 'Motivated by milestones — will embrace complex strategies like Mega Backdoor Roth if given a clear step-by-step plan.' }] },
    ...
    me1j: { description: "Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.", isShared: false, sharedWith: '', isCritical: true, date: 'Jan 2025', membersAffected: 1, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: 'Review Goal Funding', members: 'Mark Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded. No adjustment made.' },
    me1k: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Sara Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Mark · Sara · Emma Reed', cashFlowImpact: '$2,800/mo starting Aug 2026', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
    ...
    me2: { description: 'Annual review with Mark only. Covered portfolio performance, Emma planning gaps, and RSU outlook.', isShared: false, sharedWith: '', isCritical: true, date: 'Oct 2025', membersAffected: 1, status: 'Completed', aiInsight: "Sara has been absent from the last two annual reviews (2025, 2026). A dedicated 1:1 can re-anchor her as an active co-client.", aiActionLabel: 'Schedule 1:1 with Sara', members: 'Mark Reed (Sara absent)', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Notes filed. No joint follow-up scheduled.' },
    ...
    me6: { description: 'Reviewed performance and congratulated Mark on baby Emma; Sara absent again. Confirmed follow-ups on insurance and education funding.', isShared: false, sharedWith: '', isCritical: false, date: 'Aug 2026', membersAffected: 1, status: 'Scheduled', aiInsight: null, aiActionLabel: null, members: 'Mark Reed', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Meeting invite sent.' },
    me7a: { description: 'Rebalanced the joint brokerage to target allocation after drift and reaffirmed long-term growth objectives.', isShared: true, sharedWith: 'Mark Reed', isCritical: false, date: 'Nov 2020', membersAffected: 2, status: 'Completed', aiInsight: null, aiActionLabel: null, members: 'Sara · Mark Reed', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Financial snapshot documented.' },
    me7b: { description: "Opened a Roth IRA for Sara to add tax-free retirement growth and diversify the household's tax exposure.", isShared: false, sharedWith: '', isCritical: false, date: 'Mar 2022', membersAffected: 1, status: 'Active', aiInsight: null, aiActionLabel: null, members: 'Sara Reed', cashFlowImpact: '$500/mo contribution', beneficiaries: 'Mark Reed', actionTaken: 'Account opened and max funded.' },
    ...
    me7f: { description: "Established a $45K new-car fund targeting 2027, funded from the joint brokerage; later at risk as a market dip pressured the funding source.", isShared: false, sharedWith: '', isCritical: true, date: 'Jan 2025', membersAffected: 1, status: 'At Risk', aiInsight: "The $45K car goal (target 2027) relies on brokerage growth. A recent market dip has put the timeline at risk — rebalance or adjust.", aiActionLabel: 'Review Goal Funding', members: 'Mark Reed', cashFlowImpact: '$500/mo target savings', beneficiaries: null, actionTaken: 'Goal recorded.' },
    me7g: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Mark Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Sara · Mark · Emma Reed', cashFlowImpact: '–$4,200/mo (parental leave)', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
    ...
    me9a: { description: 'Emma Reed was born, the couple\'s first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.', isShared: true, sharedWith: 'Mark Reed · Sara Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'Noted', aiInsight: "Emma's college need is ~2043 (18 years out); current 529 balance is $0. College Funding Gap — Start Contributions Now. Model 529 contribution scenarios to close the projected shortfall before compounding window narrows further.", aiActionLabel: 'Model 529 scenarios', members: 'Emma · Mark · Sara Reed', cashFlowImpact: null, beneficiaries: 'Not yet designated', actionTaken: 'Emma added as household dependent.' },
        ...
        timelineMembers: [
            {
                ...
                events: [
                    ...
                    { id: 'e10', year: 2025, month: 'Jan 2025', label: 'Car Goal Set',    type: 'goal', targetYear: 2027 },
        ...
        monthlyTimelineMembers: [
            {
                ...
                events: [
                    ...
                    { id: 'me1j', month: 'Jan 2025', label: 'Car Goal Set',      type: 'goal', targetYear: 2027 },
                    ...
                    { id: 'me6',  month: 'Aug 2026', label: 'Mid-Year Check-in', type: 'engagement' },
                ],
            },
            {
                memberId: 'm2',
