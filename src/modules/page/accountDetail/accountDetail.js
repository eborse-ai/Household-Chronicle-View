...
const EVENT_DETAILS = {
    ...
    e22: { description: "Emma Reed was born, the couple's first child, triggering a life-insurance review, a new education-funding goal, and updated beneficiaries.", isShared: true, sharedWith: 'Mark Reed · Emma Reed', isCritical: true, date: 'Apr 14, 2026', membersAffected: 3, status: 'No plan update', aiInsight: "Emma was born in April 2026 — no 529 plan has been opened. Starting now maximises compounding over 17+ years before college.", aiActionLabel: 'Start 529 Plan', members: 'Sara · Mark · Emma Reed', cashFlowImpact: '–$4,200/mo (parental leave)', beneficiaries: 'Not updated — Emma not named', actionTaken: 'None on record' },
    // ── Emma Reed — yearly ───────────────────────────────────────────
