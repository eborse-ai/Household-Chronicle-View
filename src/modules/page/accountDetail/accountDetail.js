...
const EVENT_DETAILS = {
    ...
    e8m: { description: 'Mid-year phone check-in with Mark to review portfolio performance. A brief engagement to keep the plan current between annual reviews.', isShared: false, sharedWith: '', isCritical: false, date: 'Mar 2024', membersAffected: 1, status: 'Completed', aiInsight: null, aiActionLabel: null, members: 'Mark Reed', cashFlowImpact: null, beneficiaries: null, actionTaken: 'Portfolio performance reviewed. No changes made.' },
    e8:  { description: "Mark enrolled in employer's high-deductible health plan and opened an HSA to cover out-of-pocket costs and build long-term tax-free savings.", isShared: false, sharedWith: '', isCritical: false, date: 'Feb 2024', membersAffected: 1, status: 'Active', aiInsight: null, aiActionLabel: null, members: 'Mark Reed', cashFlowImpact: '$3,850/yr contribution (2024 limit)', beneficiaries: 'Sara Reed', actionTaken: 'Account opened. Payroll deduction set.' },
    ...
    me1e: { description: "Mark received a significant promotion, resulting in a salary increase of approximately $15K and new RSU grants.", isShared: false, sharedWith: '', isCritical: false, date: 'Apr 2022', membersAffected: 1, status: 'Noted', aiInsight: "Salary increase creates an opportunity to boost retirement contributions and increase the car savings goal rate. Consider a Mega Backdoor Roth if the employer plan allows.", aiActionLabel: 'Review Contribution Strategy', members: 'Mark Reed', cashFlowImpact: '+$15K/yr income', beneficiaries: null, actionTaken: 'Income updated in plan.', sentimentInsights: [{ name: 'Mark Reed', role: 'Primary Client', keyword: 'Ambitious', insight: 'Motivated by milestones — will embrace complex strategies like Mega Backdoor Roth if given a clear step-by-step plan.' }] },
    ...
    me7b: { description: "Sara opened a Roth IRA funded with $6,000 (2022 limit) to complement Mark's workplace retirement plan.", isShared: false, sharedWith: '', isCritical: false, date: 'Mar 2022', membersAffected: 1, status: 'Active', aiInsight: null, aiActionLabel: null, members: 'Sara Reed', cashFlowImpact: '$500/mo contribution', beneficiaries: 'Mark Reed', actionTaken: 'Account opened and max funded.' },
        ...
        timelineMembers: [
            ...
            },
            {
                ...
                events: [
                    ...
                    { id: 'e21', year: 2025, month: 'Jan 2025', label: 'Car Goal Set',   type: 'goal', targetYear: 2027 },
